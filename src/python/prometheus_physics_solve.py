...
class DerivationEngine:
    ...
    def derive(target: str) -> Optional[Dict[str, str]]:
        ...
        derivations = {
            ...
            "maxwell_em_waves": {
                "result": "EM waves propagate at c = 1/√(μ₀ε₀)",
                "from": "Maxwell's equations in vacuum",
                "steps": [
                    "1. ∇×E = -∂B/∂t (Faraday)",
                    "2. ∇×B = μ₀ε₀∂E/∂t (Ampère-Maxwell, J=0 in vacuum)",
                    "3. Take curl of (1): ∇×(∇×E) = -∂(∇×B)/∂t",
                    "4. LHS: ∇(∇·E) - ∇²E = -∇²E (since ∇·E=0)",
                    "5. RHS: -μ₀ε₀ ∂²E/∂t²",
                    "6. Wave equation: ∇²E = μ₀ε₀ ∂²E/∂t²",
                    "7. Speed: v = 1/√(μ₀ε₀) = 3×10⁸ m/s = c (light!)",
                ],
            },
            "hydrogen_spectrum": {
                "result": "E_n = -13.6 eV/n²",
                "from": "Schrödinger equation with Coulomb potential",
                "steps": [
                    "1. H = -ℏ²∇²/2m - e²/(4πε₀r)",
                    "2. Separate variables: ψ = R(r)Y_l^m(θ,φ)",
                    "3. Radial equation with effective potential",
                    "4. Require normalizability → quantization: n=1,2,3,...",
                    "5. E_n = -me⁴/(2ℏ²) × 1/n² = -13.6eV/n²",
                    "6. Degeneracy: n² (without spin) or 2n² (with spin)",
                ],
            },
            "ideal_gas_law": {
                "result": "PV = NkT",
                ...
                "steps": [
                    "1. Gas = N particles in box, random velocities",
                    "2. Pressure = force/area = momentum transfer rate to wall",
                    "3. One particle hitting wall: Δp = 2mv_x per collision",
                    "4. Collision rate with wall: v_x/(2L) per particle",
                    "5. Force on wall: F = N⟨2mv_x²⟩/(2L) = Nm⟨v_x²⟩/L",
                    "6. Pressure: P = F/A = Nm⟨v_x²⟩/V",
                    "7. Equipartition: ½m⟨v_x²⟩ = ½kT",
                    "8. P = NkT/V → PV = NkT",
                ],
            },
            "stefan_boltzmann": {
                "result": "P = σT⁴ where σ = 2π⁵k⁴/(15h³c²)",
                "from": "Integrate Planck distribution over all frequencies",
                "steps": [
                    "1. Planck: u(ν) = 8πhν³/c³ × 1/(e^{hν/kT}-1)",
                    "2. Total energy density: u = ∫₀^∞ u(ν) dν",
                    "3. Substitute x = hν/kT: dν = (kT/h)dx",
                    "4. u = (8πk⁴T⁴/h³c³) ∫₀^∞ x³/(e^x-1) dx",
                    "5. The integral = π⁴/15 (known result)",
                    "6. u = (8π⁵k⁴/15h³c³)T⁴ = aT⁴",
                    "7. Power per area: P/A = uc/4 = σT⁴",
                    "8. σ = 2π⁵k⁴/(15h³c²) = 5.67×10⁻⁸ W/(m²K⁴)",
                ],
            },
            "schrodinger_from_debroglie": {
                "result": "iℏ∂ψ/∂t = -ℏ²∇²ψ/2m + Vψ",
                "from": "de Broglie + wave equation consistency",
                "steps": [
                    "1. de Broglie: p = ℏk, E = ℏω",
                    "2. Free particle wave: ψ = e^{i(kx-ωt)}",
                    "3. ∂ψ/∂t = -iωψ → iℏ∂ψ/∂t = ℏωψ = Eψ",
                    "4. ∂²ψ/∂x² = -k²ψ → -ℏ²∇²ψ/2m = (ℏk)²ψ/2m = p²ψ/2m",
                    "5. For free particle: E = p²/2m → iℏ∂ψ/∂t = -ℏ²∇²ψ/2m",
                    "6. Add potential: E = p²/2m + V → iℏ∂ψ/∂t = [-ℏ²∇²/2m + V]ψ",
                ],
            },
            "lorentz_force_from_lagrangian": {
                "result": "F = q(E + v×B)",
                "from": "Lagrangian L = ½mv² - qφ + qv·A",
                "steps": [
                    "1. Lagrangian: L = ½mv² - qφ + qv·A",
                    "2. Canonical momentum: p = ∂L/∂v = mv + qA",
                    "3. Euler-Lagrange: d(mv+qA)/dt = -q∇φ + q∇(v·A)",
                    "4. d(mv)/dt = -q∇φ - q∂A/∂t + q∇(v·A) - q(v·∇)A",
                    "5. E = -∇φ - ∂A/∂t and B = ∇×A",
                    "6. Using vector identity: ∇(v·A)-(v·∇)A = v×(∇×A) = v×B",
                    "7. F = q(E + v×B) — the Lorentz force!",
                ],
            },
            "carnot_efficiency": {
                "result": "η = 1 - T_c/T_h",
                "from": "Second law of thermodynamics + reversibility",
                "steps": [
                    "1. Reversible cycle: ΔS_total = 0",
                    "2. Heat in at T_h: ΔS_h = -Q_h/T_h",
                    "3. Heat out at T_c: ΔS_c = +Q_c/T_c",
                    "4. ΔS_total = Q_c/T_c - Q_h/T_h = 0",
                    "5. Therefore: Q_c/Q_h = T_c/T_h",
                    "6. Work: W = Q_h - Q_c",
                    "7. η = W/Q_h = 1 - Q_c/Q_h = 1 - T_c/T_h",
                ],
            },
            "entropy_boltzmann": {
                "result": "S = k_B ln Ω",
                "from": "Statistical mechanics + thermodynamic consistency",
                "steps": [
                    "1. Want S that is additive: S(A+B) = S(A) + S(B)",
                    "2. Microstates are multiplicative: Ω(A+B) = Ω(A)×Ω(B)",
                    "3. Only function with f(xy) = f(x)+f(y) is logarithm",
                    "4. S = k × ln Ω (k sets units)",
                    "5. Match to ideal gas: gives k = k_B (Boltzmann constant)",
                    "6. Maximum Ω ↔ equilibrium ↔ maximum S (2nd law)",
                ],
            },
            "time_dilation": {
                "result": "Δt = γΔτ = Δτ/√(1-v²/c²)",
                "from": "Light clock thought experiment",
                "steps": [
                    "1. Light clock: photon bounces between mirrors, distance D",
                    "2. In rest frame: tick time Δτ = 2D/c",
                    "3. Moving frame sees photon travel diagonal path",
                    "4. Diagonal distance: √(D² + (vΔt/2)²) each way",
                    "5. Time: Δt = 2√(D²+(vΔt/2)²)/c",
                    "6. Solve: Δt² = 4D²/c² + v²Δt²/c²",
                    "7. Δt²(1-v²/c²) = (2D/c)² = Δτ²",
                    "8. Δt = Δτ/√(1-v²/c²) = γΔτ",
                ],
            },
            "blackbody_peak_wien": {
                "result": "λ_max T = 2.898×10⁻³ m·K",
                "from": "Maximize Planck distribution w.r.t. wavelength",
                "steps": [
                    "1. Planck in wavelength: u(λ) = 8πhc/λ⁵ × 1/(e^{hc/λkT}-1)",
                    "2. Maximum: du/dλ = 0",
                    "3. Let x = hc/(λkT), then solve: 5(1-e^{-x}) = x",
                    "4. Numerical solution: x ≈ 4.965",
                    "5. λ_max = hc/(4.965 kT)",
                    "6. λ_max × T = hc/(4.965k) = 2.898×10⁻³ m·K",
                ],
            },
            "compton_scattering": {
                "result": "Δλ = (h/mc)(1-cosθ)",
                "from": "Conservation of energy + momentum (photon + electron)",
                "steps": [
                    "1. Photon: E=hc/λ, p=h/λ",
                    "2. Energy conservation: hc/λ + mc² = hc/λ' + γmc²",
                    "3. Momentum x: h/λ = h/λ'·cosθ + γmv·cosφ",
                    "4. Momentum y: 0 = h/λ'·sinθ - γmv·sinφ",
                    "5. Eliminate electron variables (square and add momenta)",
                    "6. Result: 1/λ' - 1/λ = (1/mc)(1-cosθ)/λλ'... simplifies to",
                    "7. Δλ = λ'-λ = (h/mc)(1-cosθ) = λ_C(1-cosθ)",
                ],
            },
            "bohr_model": {
                "result": "r_n = n²a₀, E_n = -13.6/n² eV",
                "from": "Quantize angular momentum: L = nℏ",
                "steps": [
                    "1. Centripetal = Coulomb: mv²/r = e²/(4πε₀r²)",
                    "2. Quantize: mvr = nℏ → v = nℏ/(mr)",
                    "3. Substitute (2) into (1): m(nℏ)²/(m²r³) = e²/(4πε₀r²)",
                    "4. Solve for r: r_n = 4πε₀ℏ²n²/(me²) = n²a₀",
                    "5. a₀ = 0.529Å (Bohr radius)",
                    "6. Energy: E = ½mv² - e²/(4πε₀r) = -e²/(8πε₀r_n)",
                    "7. E_n = -13.6eV/n²",
                ],
            },
            "photoelectric_einstein": {
                "result": "KE_max = hf - φ (work function)",
                "from": "Light quanta (photons) + energy conservation",
                "steps": [
                    "1. Einstein postulate: light comes in quanta E = hf",
                    "2. One photon absorbed by one electron",
                    "3. Energy to escape: φ (work function of metal)",
                    "4. Conservation: hf = KE + φ",
                    "5. Maximum KE: KE_max = hf - φ",
                    "6. Threshold: f_min = φ/h (no emission below this)",
                    "7. Explains: intensity affects #electrons, not energy!",
                ],
            },
            "hubble_from_friedmann": {
                "result": "v = H₀d (Hubble's law from expanding universe)",
                "from": "Friedmann equations + FRW metric",
                "steps": [
                    "1. FRW metric: ds² = -c²dt² + a(t)²[dr²/(1-kr²)+r²dΩ²]",
                    "2. Physical distance: d = a(t)×r (comoving × scale factor)",
                    "3. Velocity: v = ḋ = ȧr = (ȧ/a)×(ar) = H×d",
                    "4. Hubble parameter: H(t) = ȧ/a",
                    "5. Today: H₀ = H(t₀) ≈ 70 km/s/Mpc",
                    "6. All galaxies recede: v = H₀d (Hubble's law)",
                    "7. NOT motion through space — space itself expands!",
                ],
            },
            "bcs_gap": {
                "result": "Δ(0) = 2ℏω_D exp(-1/N(0)V)",
                "from": "Cooper pair instability + self-consistency",
                "steps": [
                    "1. Fermi sea unstable to attractive interaction (phonon-mediated)",
                    "2. Cooper pairs form: (k↑, -k↓) bound state",
                    "3. Gap equation: 1 = V∫₀^{ℏω_D} dε/√(ε²+Δ²)",
                    "4. Solve at T=0: Δ(0) = 2ℏω_D exp(-1/N(0)V)",
                    "5. T_c = 1.13 ℏω_D/k_B × exp(-1/N(0)V)",
                    "6. Universal ratio: 2Δ(0)/k_BT_c = 3.53",
                ],
            },
            "hall_effect": {
                "result": "R_H = 1/(nec), V_H = IB/(net)",
                "from": "Balance of electric and magnetic forces on carriers",
                "steps": [
                    "1. Current I flows in x, magnetic field B in z",
                    "2. Lorentz: F_mag = qv_d×B pushes carriers to one side",
                    "3. Charge accumulates → transverse electric field E_y",
                    "4. Equilibrium: qE_y = qv_dB",
                    "5. Current density: J = nqv_d → v_d = J/(nq)",
                    "6. Hall voltage: V_H = E_y×w = v_d×B×w = IB/(nqt)",
                    "7. Hall coefficient: R_H = E_y/(JB) = 1/(nq)",
                    "8. Sign of R_H reveals carrier type (electron vs hole)!",
                ],
            },
            "chandrasekhar_limit": {
                "result": "M_Ch ≈ 1.4 M_☉",
                "from": "Balance of gravity and electron degeneracy pressure",
                "steps": [
                    "1. White dwarf: electrons are degenerate (Fermi gas)",
                    "2. Degeneracy pressure: P ~ ℏ²n^{5/3}/(m_e) (non-rel)",
                    "3. Gravity: P_grav ~ GM²/R⁴",
                    "4. As M increases, density rises → electrons become relativistic",
                    "5. Relativistic: P ~ ℏcn^{4/3} (weaker dependence on n)",
                    "6. At critical mass: P_degeneracy cannot support gravity",
                    "7. M_Ch = (ℏc/G)^{3/2} / (μ_e m_p)² ≈ 1.44 M_☉",
                    "8. Above this: collapse to neutron star or black hole!",
                ],
            },
            "lamb_shift_qualitative": {
                "result": "2S_{1/2} is higher than 2P_{1/2} by ~1058 MHz",
                "from": "Vacuum fluctuations (QED effect)",
                "steps": [
                    "1. Dirac equation predicts 2S_{1/2} = 2P_{1/2} (degenerate)",
                    "2. QED: electron interacts with virtual photons (vacuum fluctuations)",
                    "3. Electron 'smeared' over δr ~ α×a₀ (jittering)",
                    "4. S-states (l=0) have |ψ(0)|²>0 (touch nucleus) → more smearing",
                    "5. P-states (l=1) have ψ(0)=0 → less affected",
                    "6. Net effect: 2S pushed UP relative to 2P",
                    "7. Δf ≈ (α⁵mc²/h) × (8/3π)ln(1/α) ≈ 1058 MHz",
                ],
            },
            "equivalence_principle_redshift": {
                "result": "Δf/f = -gh/c² (gravitational redshift)",
                "from": "Equivalence principle + elevator thought experiment",
                "steps": [
                    "1. Equivalence: gravity = acceleration (locally)",
                    "2. Photon emitted at floor of accelerating elevator (a=g)",
                    "3. By time photon reaches ceiling (height h): ceiling moved",
                    "4. Extra velocity of ceiling: Δv = g×(h/c)",
                    "5. Doppler shift: Δf/f = -Δv/c = -gh/c²",
                    "6. By equivalence: same shift in gravitational field",
                    "7. Δf/f = -ΔΦ/c² where Φ = gravitational potential",
                    "8. Verified: Pound-Rebka experiment (1959), GPS satellites",
                ],
            },
            "de_broglie_wavelength": {
                "result": "λ = h/p = h/(mv) for matter waves",
                "from": "Analogy with photon E=hf and special relativity",
                "steps": [
                    "1. For photons: E=hf and E=pc → p=h/λ → λ=h/p",
                    "2. de Broglie hypothesis: same for ALL particles",
                    "3. For particle with momentum p: λ = h/p = h/(mv)",
                    "4. Verified: Davisson-Germer electron diffraction (1927)",
                    "5. Thermal neutrons (T=300K): λ ~ 1.5Å ≈ atomic spacing",
                    "6. Electron at 100eV: λ ~ 1.2Å (used in electron microscopy)",
                ],
            },
            "fermi_energy_derivation": {
                "result": "E_F = (ℏ²/2m)(3π²n)^{2/3}",
                "from": "Fill up states in 3D k-space up to Fermi surface",
                "steps": [
                    "1. Free electrons in box: k = (2π/L)(n_x, n_y, n_z)",
                    "2. Each k-state holds 2 electrons (spin up + down)",
                    "3. At T=0: fill all states up to k_F (Fermi wavevector)",
                    "4. Number of states up to k_F: N = 2×(4πk_F³/3)/(2π/L)³",
                    "5. Simplify: N/V = k_F³/(3π²) → k_F = (3π²n)^{1/3}",
                    "6. Fermi energy: E_F = ℏ²k_F²/(2m) = (ℏ²/2m)(3π²n)^{2/3}",
                    "7. For copper (n~8.5×10²⁸/m³): E_F ≈ 7 eV",
                ],
            },
        }
    ...
    def available_derivations() -> List[str]:
        ...
        return ["E=mc2", "hawking_temperature", "schwarzschild_radius",
                ...
                "dirac_equation", "noether_energy", "maxwell_em_waves",
                "hydrogen_spectrum", "ideal_gas_law", "stefan_boltzmann",
                "schrodinger_from_debroglie", "lorentz_force_from_lagrangian",
                "carnot_efficiency", "entropy_boltzmann", "time_dilation",
                "blackbody_peak_wien", "compton_scattering", "bohr_model",
                "photoelectric_einstein", "hubble_from_friedmann", "bcs_gap",
                "hall_effect", "chandrasekhar_limit", "lamb_shift_qualitative",
                "equivalence_principle_redshift", "de_broglie_wavelength",
                "fermi_energy_derivation"]
...
class FermiEstimator:
    ...
    def estimate(question: str) -> Optional[Dict[str, str]]:
        ...
        estimates = {
            ...
            "grains_sand_beach": {
                "answer": "~10¹⁸ grains on all beaches",
                "reasoning": [
                    "Total beach area: ~10⁵ km coastline × 50m wide = 5×10⁹ m²",
                    "Beach depth: ~2 m → volume: ~10¹⁰ m³",
                    "Grain size: ~0.5 mm → volume: ~10⁻¹⁰ m³",
                    "Packing fraction: ~0.6",
                    "Grains: 0.6 × 10¹⁰ / 10⁻¹⁰ ≈ 6×10¹⁹",
                    "Order of magnitude: ~10¹⁸ to 10¹⁹",
                ],
            },
            "stars_visible_universe": {
                "answer": "~10²³ stars",
                "reasoning": [
                    "Observable universe: ~2×10¹¹ galaxies (Hubble/JWST)",
                    "Average galaxy: ~10¹¹ stars (like Milky Way)",
                    "Total: ~2×10²² to 10²³ stars",
                    "More than grains of sand on Earth!",
                ],
            },
            "air_molecules_room": {
                "answer": "~10²⁷ molecules",
                "reasoning": [
                    "Room: 5m×5m×3m = 75 m³",
                    "Ideal gas: n/V = P/(kT) = 10⁵/(1.38×10⁻²³×300)",
                    "= 2.4×10²⁵ molecules/m³",
                    "Total: 75 × 2.4×10²⁵ ≈ 2×10²⁷",
                ],
            },
            "time_for_light_to_moon": {
                "answer": "~1.3 seconds",
                "reasoning": [
                    "Moon distance: ~384,000 km = 3.84×10⁸ m",
                    "Speed of light: 3×10⁸ m/s",
                    "Time: 3.84×10⁸ / 3×10⁸ = 1.28 s",
                ],
            },
            "weight_atmosphere": {
                "answer": "~5×10¹⁸ kg",
                "reasoning": [
                    "Atmospheric pressure: 10⁵ Pa = 10⁵ N/m²",
                    "Earth surface area: 4πR² = 4π(6.4×10⁶)² ≈ 5.1×10¹⁴ m²",
                    "Total weight: F = PA = 10⁵ × 5.1×10¹⁴ = 5.1×10¹⁹ N",
                    "Mass: 5.1×10¹⁹/9.81 ≈ 5.2×10¹⁸ kg",
                ],
            },
            "energy_in_lightning": {
                "answer": "~1 GJ (1 billion joules)",
                "reasoning": [
                    "Voltage: ~300 million volts (3×10⁸ V)",
                    "Current: ~30,000 A peak, avg ~3000 A",
                    "Duration: ~0.001 seconds",
                    "Energy: V×I×t ~ 3×10⁸ × 3000 × 0.001 ≈ 10⁹ J = 1 GJ",
                    "Actually ~1-5 GJ per stroke (varies widely)",
                ],
            },
            "depth_ocean_average": {
                "answer": "~3.7 km average depth",
                "reasoning": [
                    "Ocean volume: ~1.335×10¹⁸ m³",
                    "Ocean area: ~3.6×10¹⁴ m²",
                    "Average depth: V/A = 1.335×10¹⁸/3.6×10¹⁴ ≈ 3700 m",
                ],
            },
            "cells_human_body": {
                "answer": "~37 trillion (3.7×10¹³)",
                "reasoning": [
                    "Cell volume: ~1000-10000 μm³ ≈ 10⁻¹⁵ m³ average",
                    "Body volume: ~0.07 m³",
                    "Rough estimate: 0.07/10⁻¹⁵ ~ 10¹³",
                    "Actual count (2013 study): 3.7×10¹³",
                    "Plus ~3.8×10¹³ bacteria (roughly equal!)",
                ],
            },
            "photons_from_lightbulb": {
                "answer": "~10²⁰ photons per second (100W bulb)",
                "reasoning": [
                    "100W bulb, ~5% visible light → 5W of photons",
                    "Average visible photon energy: E = hf ≈ 6.6×10⁻³⁴×6×10¹⁴ ≈ 4×10⁻¹⁹ J",
                    "Photons/sec: 5/(4×10⁻¹⁹) ≈ 1.3×10¹⁹",
                    "Including IR (95%): total ~2×10²⁰/s",
                ],
            },
            "speed_of_earth_orbit": {
                "answer": "~30 km/s (107,000 km/h)",
                "reasoning": [
                    "Orbit circumference: 2π×1.5×10¹¹ m ≈ 9.4×10¹¹ m",
                    "Period: 1 year = 3.15×10⁷ s",
                    "Speed: 9.4×10¹¹/3.15×10⁷ ≈ 30,000 m/s = 30 km/s",
                ],
            },
            "mass_of_visible_universe": {
                "answer": "~10⁵³ kg",
                "reasoning": [
                    "Observable universe radius: ~4.4×10²⁶ m",
                    "Critical density: ~10⁻²⁶ kg/m³",
                    "Volume: (4/3)π(4.4×10²⁶)³ ≈ 3.6×10⁸⁰ m³",
                    "Mass: 10⁻²⁶ × 3.6×10⁸⁰ ≈ 3.6×10⁵⁴ kg",
                    "Only ~5% baryonic → ordinary matter: ~10⁵³ kg",
                ],
            },
            "transistors_in_modern_cpu": {
                "answer": "~50-100 billion (2024+ chips)",
                "reasoning": [
                    "Apple M3 Ultra: 92 billion transistors",
                    "NVIDIA H100: 80 billion",
                    "Node: 3-5 nm feature size",
                    "Die area: ~800 mm²",
                    "Density: ~100 million transistors/mm²",
                ],
            },
            "data_generated_per_day": {
                "answer": "~400 exabytes per day (2025)",
                "reasoning": [
                    "Global data creation 2025: ~150 zettabytes/year",
                    "Per day: 150×10²¹ / 365 ≈ 4×10²⁰ bytes = 400 EB",
                    "Equivalent to ~400 million 1TB hard drives per day",
                ],
            },
            "escape_velocity_galaxy": {
                "answer": "~550 km/s from Milky Way at Sun's location",
                "reasoning": [
                    "Milky Way mass within solar orbit: ~10¹¹ M_☉ ≈ 2×10⁴¹ kg",
                    "Sun's distance from center: 8 kpc ≈ 2.5×10²⁰ m",
                    "v_esc = √(2GM/r) = √(2×6.67×10⁻¹¹×2×10⁴¹/2.5×10²⁰)",
                    "≈ √(10¹¹) ≈ 3×10⁵ m/s ≈ 300-550 km/s",
                    "Measured: ~550 km/s (includes dark matter halo)",
                ],
            },
            "heartbeats_lifetime": {
                "answer": "~3 billion beats in a lifetime",
                "reasoning": [
                    "Heart rate: ~70 bpm average",
                    "Minutes in 80 years: 80×365.25×24×60 ≈ 4.2×10⁷",
                    "Beats: 70 × 4.2×10⁷ ≈ 2.9×10⁹ ≈ 3 billion",
                ],
            },
            "water_drops_in_ocean": {
                "answer": "~10²⁵ drops",
                "reasoning": [
                    "Ocean volume: ~1.335×10¹⁸ m³",
                    "Drop volume: ~0.05 mL = 5×10⁻⁸ m³",
                    "Drops: 1.335×10¹⁸ / 5×10⁻⁸ ≈ 2.7×10²⁵",
                ],
            },
            "sun_hydrogen_consumed": {
                "answer": "~620 million tonnes per second",
                "reasoning": [
                    "Solar luminosity: 3.8×10²⁶ W",
                    "E=mc²: mass converted = L/c² = 3.8×10²⁶/(9×10¹⁶) ≈ 4.2×10⁹ kg/s",
                    "But only 0.7% of hydrogen mass converts to energy",
                    "Hydrogen consumed: 4.2×10⁹/0.007 ≈ 6×10¹¹ kg/s = 600M tonnes/s",
                ],
            },
            "temperature_center_sun": {
                "answer": "~15 million Kelvin",
                "reasoning": [
                    "Virial theorem: T ~ GMm_p/(kR)",
                    "T ~ (6.67×10⁻¹¹ × 2×10³⁰ × 1.67×10⁻²⁷) / (1.38×10⁻²³ × 7×10⁸)",
                    "T ~ 2.2×10⁻⁷ / 10⁻¹⁴ ≈ 2×10⁷ K",
                    "Actual (from models): 1.57×10⁷ K",
                ],
            },
            "density_neutron_star": {
                "answer": "~10¹⁷ kg/m³ (like a nucleus)",
                "reasoning": [
                    "Neutron star: M ~ 1.4 M_☉ ≈ 2.8×10³⁰ kg",
                    "Radius: ~10 km = 10⁴ m",
                    "Volume: (4/3)π(10⁴)³ ≈ 4×10¹² m³",
                    "Density: 2.8×10³⁰/4×10¹² ≈ 7×10¹⁷ kg/m³",
                    "Compare: nuclear density = 2.3×10¹⁷ kg/m³",
                    "A teaspoon weighs ~5 billion tonnes!",
                ],
            },
            "power_received_earth_from_sun": {
                "answer": "~1.7×10¹⁷ W (170 petawatts)",
                "reasoning": [
                    "Solar constant: 1361 W/m²",
                    "Earth cross-section: πR² = π(6.4×10⁶)² ≈ 1.3×10¹⁴ m²",
                    "Power: 1361 × 1.3×10¹⁴ ≈ 1.7×10¹⁷ W",
                    "Human civilization uses ~2×10¹³ W (10,000× less!)",
                ],
            },
            "wavelength_of_person": {
                "answer": "~10⁻³⁵ m (way below Planck length!)",
                "reasoning": [
                    "de Broglie: λ = h/p = h/(mv)",
                    "Person: m=70 kg, walking v=1 m/s",
                    "λ = 6.6×10⁻³⁴/(70×1) ≈ 10⁻³⁵ m",
                    "This is ~Planck length! Completely unobservable.",
                    "That's why we don't diffract through doorways.",
                ],
            },
            "entropy_of_black_hole": {
                "answer": "~10⁷⁷ k_B for solar-mass BH",
                "reasoning": [
                    "Bekenstein-Hawking: S = k_B c³A/(4Gℏ)",
                    "Schwarzschild radius: r_s = 2GM/c² ≈ 3 km for M_☉",
                    "Area: A = 4πr_s² ≈ 10⁸ m²",
                    "S = 1.38×10⁻²³ × (3×10⁸)³ × 10⁸ / (4×6.67×10⁻¹¹×10⁻³⁴)",
                    "S ≈ 10⁷⁷ k_B",
                    "This is WAY more than the star's entropy before collapse (~10⁵⁸)!",
                ],
            },
        }
        # Try to match
